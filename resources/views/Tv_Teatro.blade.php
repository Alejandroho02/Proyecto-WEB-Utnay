   ...
   <!-- Aqui van los apartados de cada contenido -->
    <div>
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/tele1.png" class="card-img-top" alt="tele1">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/tele2.png" class="card-img-top" alt="tele2">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/tele3.png" class="card-img-top" alt="tele3">
                            <div class="card-body">
                                <h5 class="card-title">A80L| BRAVIA XR | OLED | 4K Ultra HD | Smart TV (Google TV)</h5>                                
                                <p class="card-text">MODELO XR-55A80L UCM   
                                    55 Pulgadas
        ...
        <div class="p-3 mb-2 bg-info-subtle text-emphasis-info" id="Teatroscasa">
            ...
            <div>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/sonido1.png" class="card-img-top" alt="sonido1">
                        <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/sonido2.png" class="card-img-top" alt="sonido2">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/sonido3.png" class="card-img-top" alt="sonido3">
                            <div class="card-body">
        ...
        <div id="Bluray">
            <div>
                <br>
                <p><h1>Reproductores de Blu-ray disc y DVD</h1></p>
                <br>
            </div>
            <div>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/dvd1.png" class="card-img-top" alt="dvd1">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/dvd2.png" class="card-img-top" alt="dvd2">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="Img/tv_treatro/dvd3.png" class="card-img-top" alt="dvd3">
                            <div class="card-body">
