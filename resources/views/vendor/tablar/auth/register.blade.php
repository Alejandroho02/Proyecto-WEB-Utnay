...
@section('content')
    <div class="container container-tight py-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Aceptar <a href="#" tabindex="-1">Terminos y Condiciones</a>.</span>
                    </label>
                </div>
        ...
        <div class="text-center text-muted mt-3">
            Ya tienes una cuenta? <a href="{{route('login')}}" tabindex="-1">Iniciar sesion</a>
        </div>
    </div>
@endsection
